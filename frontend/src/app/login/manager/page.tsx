...
export default function ManagerLoginPage() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    // Mock Authentication
    setTimeout(() => {
      if (email.trim().toLowerCase() === "manager@placementportal.com" && password === "Manager@123") {
        login("MANAGER");
    ...
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:flex flex-col justify-center items-center w-1/2 bg-slate-900 text-white p-12">
        <div className="max-w-md space-y-6 text-center">
          ...
          <div>
            <h1 className="text-3xl font-bold tracking-tight">Manager Portal</h1>
            <p className="text-blue-400 font-semibold text-xs mt-1">Rathinam Technical Campus (Autonomous)</p>
          </div>
          <p className="text-slate-300 text-sm">
            Manage students, company relations, drives, and placement activities efficiently.
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col justify-center items-center w-full lg:w-1/2 p-8 bg-slate-50 relative">
        ...
        <Card className="w-full max-w-md border-0 shadow-none bg-transparent">
          <CardHeader className="space-y-2 px-0">
            <CardTitle className="text-3xl text-slate-900">Manager Login</CardTitle>
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Input
                  id="email"
                  type="email"
                  placeholder="manager@placementportal.com"
                  value={email}
