...
export default function AdminLoginPage() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    // Mock Authentication
    setTimeout(() => {
      if (email.trim().toLowerCase() === "admin@placementportal.com" && password === "Admin@123") {
        login("ADMIN");
      ...
      <div className="hidden lg:flex flex-col justify-center items-center w-1/2 bg-slate-900 text-white p-12">
        <div className="max-w-md space-y-6 text-center">
          ...
          <p className="text-slate-300 text-sm">
            Full access to placement management, candidate ATS matching, and system administration.
          </p>
        </div>
      </div>
